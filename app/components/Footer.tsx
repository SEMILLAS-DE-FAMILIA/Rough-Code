  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.waveContainer}>
        ...
        >
          <path
            d="M0,32 C480,120 960,0 1440,64 L1440,120 L0,120 Z"
            fill="var(--color-primary-brown, #4E2C1D)"
          />
        </svg>
      </div>
      ...
      <div className={styles.footerContent}>
        ...
        {/* Sección central con enlaces institucionales y botones de contacto alineados */}
        <div className={styles.footerMainGrid}>
          
          {/* Bloque Acerca de */}
          <div className={styles.footerColumn}>
            <h4 className={styles.sectionTitle}>ACERCA DE</h4>
            <nav className={styles.footerNav}>
              <Link href="/nosotros" className={styles.footerLink}>Sobre nosotros</Link>
              <Link href="/preguntas-frecuentes" className={styles.footerLink}>Preguntas frecuentes</Link>
              <Link href="/terminos" className={styles.footerLink}>Términos y condiciones</Link>
            </nav>
          </div>

          {/* Bloque Contáctanos / Redes Sociales */}
          <div className={styles.footerColumn}>
            ...
            <div className={styles.contactButtonsContainer}>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`${styles.contactBtn} ${styles.facebookBtn}`}
              >
                <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
        ...
        <p className={styles.copyright}>
          © {new Date().getFullYear()} Semillas de Familia. Todos los derechos reservados.
        </p>
      </div>
    </footer>
  );
